...
// Posix-specific methods for the DigitalBitsCoreRunner type.

func (c *digitalbitsCoreRunner) getPipeName() string {
...
func (c *digitalbitsCoreRunner) start(cmd *exec.Cmd) (pipe, error) {
	...
	if err != nil {
		writeFile.Close()
		readFile.Close()
		return pipe{}, errors.Wrap(err, "error starting digitalbits-core")
	}
