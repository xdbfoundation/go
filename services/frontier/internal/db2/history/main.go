...
// reading rows from a the history portion of frontier's database
package history
...
// Offer is row of data from the `offers` table from frontier DB
type Offer struct {
...
// portion of the frontier database.
type Q struct {
	*db.Session
}
...
// TrustLine is row of data from the `trust_lines` table from frontier DB
