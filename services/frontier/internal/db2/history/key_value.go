...
const (
	...
	// Distributed ingestion in Frontier relies on this key and it is part
...
// This is used in status reporting (ex. in root resource of Frontier).
...
// in Frontier. Returns ErrKeyNotFound error if no value has been previously set.
