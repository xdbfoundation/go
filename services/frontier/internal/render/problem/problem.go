...
var (
	...
	ServerOverCapacity = problem.P{
		...
		Status: http.StatusServiceUnavailable,
		Detail: "This frontier server is currently overloaded.  Please wait for " +
	...
	BeforeHistory = problem.P{
		...
		Detail: "This frontier instance is configured to only track a " +
	...
	StaleHistory = problem.P{
		...
		Status: http.StatusServiceUnavailable,
		Detail: "This frontier instance is configured to reject client requests " +
