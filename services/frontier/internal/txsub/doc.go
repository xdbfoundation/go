// Package txsub provides the machinery that frontier uses to submit transactions to
// the digitalbits network and track their progress.  It also helps to hide some of the
