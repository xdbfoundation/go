...
func pageableToOffers(t *testing.T, page []hal.Pageable) []frontier.Offer {
	var offers []frontier.Offer
	for _, entry := range page {
		offers = append(offers, entry.(frontier.Offer))
	}
	return offers
}
