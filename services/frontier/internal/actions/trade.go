...
func (handler GetTradeAggregationsHandler) GetResource(w HeaderWriter, r *http.Request) (interface{}, error) {
	...
	aggregations := []frontier.TradeAggregation{}
	for _, record := range records {
...
func (handler GetTradeAggregationsHandler) buildPage(r *http.Request, records []frontier.TradeAggregation) (hal.Page, error) {
	ctx := r.Context()
