...
1. A History Archive <sup>[1](https://developers.digitalbits.io/software/DigitalBits/docs/software/admin#history-archives),[2](https://github.com/xdbfoundation/DigitalBits/blob/master/docs/history.md)</sup>, which is generated by `digitalbits-core` and provides a complete copy of a recent [ledger](https://developers.digitalbits.io/guides/docs/guides/concepts/ledger) as well as a history of `TransactionResult` XDR objects, which in turn contain [operation results](https://github.com/xdbfoundation/DigitalBits/blob/master/src/xdr/DigitalBits-transaction.x#L382-L834).
