...
1. A History Archive <sup>[1](https://github.com/xdbfoundation/DigitalBits/blob/master/docs/software/admin.md#history-archives),[2](https://github.com/xdbfoundation/DigitalBits/blob/master/docs/history.md)</sup>, which is generated by `digitalbits-core` and provides a complete copy of a recent [ledger](https://developers.digitalbits.io/guides/concepts/ledger.html) as well as a history of `TransactionResult` XDR objects, which in turn contain [operation results](https://github.com/xdbfoundation/DigitalBits/blob/master/src/xdr/DigitalBits-transaction.x#L382-L834).
