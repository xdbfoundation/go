...
func PopulateRoot(
	...
	dest.FrontierSequence = ledgerState.HistoryLatest
	dest.FrontierLatestClosedAt = ledgerState.HistoryLatestClosedAt
	dest.HistoryElderSequence = ledgerState.HistoryElder
	dest.CoreSequence = ledgerState.CoreLatest
	dest.FrontierVersion = hVersion
	dest.DigitalBitsCoreVersion = cVersion
