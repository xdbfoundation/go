...
func (p *TradeProcessor) extractTrades(
	...
	for opidx, op := range transaction.Envelope.Operations() {
		...
		case xdr.OperationTypeCreatePassiveSellOffer:
			...
			// KNOWN ISSUE:  digitalbits-core creates results for CreatePassiveOffer operations
		...
		for order, trade := range trades {
			// digitalbits-core will opportunisticly garbage collect invalid offers (in the
