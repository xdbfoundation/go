...
type ResumeTestTestSuite struct {
	...
	digitalbitsCoreClient *mockDigitalBitsCoreClient
	system            *system
}
...
func (s *ResumeTestTestSuite) SetupTest() {
	...
	s.digitalbitsCoreClient = &mockDigitalBitsCoreClient{}
	s.system = &system{
		...
		digitalbitsCoreClient: s.digitalbitsCoreClient,
...
func (s *ResumeTestTestSuite) TearDownTest() {
	...
	s.digitalbitsCoreClient.AssertExpectations(t)
}
