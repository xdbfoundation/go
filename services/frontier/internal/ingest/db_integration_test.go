...
func (s *DBTestSuite) SetupTest() {
	s.tt = test.Start(s.T())
	test.ResetFrontierDB(s.T(), s.tt.FrontierDB)
	...
	// go test -v -timeout 5m --tags=update  github.com/xdbfoundation/go/services/frontier/internal/ingest -run "^(TestUpdateSampleChanges)$"
	...
	sIface, err := NewSystem(Config{
		...
		HistorySession:           s.tt.FrontierSession(),
