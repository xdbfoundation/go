...
func TestNewSystem(t *testing.T) {
	config := Config{
		...
		HistoryArchiveURL:        "https://history.digitalbits.org/prd/core-live/core_live_001",
...
type mockDigitalBitsCoreClient struct {
	mock.Mock
}

func (m *mockDigitalBitsCoreClient) SetCursor(ctx context.Context, id string, cursor int32) error {
	args := m.Called(ctx, id, cursor)
	return args.Error(0)
}

var _ digitalbitsCoreClient = (*mockDigitalBitsCoreClient)(nil)
