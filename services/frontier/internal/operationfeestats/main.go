...
// stats within digitalbits,specifically as a central location to store a cached snapshot
...
// State represents a snapshot of frontier's view of the state of operation fee's
// on the network.
type State struct {
	FeeChargedMax  int64
	FeeChargedMin  int64
