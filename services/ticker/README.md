# Ticker
This project aims to provide an easy-to-deploy DigitalBits ticker.
...
2. Run the ticker with the mounted folder: `$ docker run --rm -it -p "8000:8000" -v
   "/path/to/data/folder:/opt/digitalbits/postgresql" ticker` (you'll also be asked to enter a
...
1. See the details in [README.md](https://github.com/xdbfoundation/go/blob/master/README.md) for installing dependencies.
