...
Usage:
  digitalbits-archivist [flags]
  digitalbits-archivist [command]
...
Flags:
  ...
  -h, --help              help for digitalbits-archivist
...
Use "digitalbits-archivist [command] --help" for more information about a command.
```

## Specifying history archives

Unlike `digitalbits-core`, `digitalbits-archivist` does not run subprocesses to access history archives;
...
`digitalbits-archivist` supports reading from and writing to any S3-compatible storage.
...
```
$ digitalbits-archivist status --s3endpoint ams3.digitaloceanspaces.com s3://bucketname/prefix
```
...
$ digitalbits-archivist status --s3endpoint https://storage.googleapis.com s3://google-storage-bucketname
``` 
...
```
$ digitalbits-archivist status http://s3-eu-west-1.amazonaws.com/history.digitalbits.org/prd/core-testnet/core_testnet_001

       Archive: http://s3-eu-west-1.amazonaws.com/history.digitalbits.org/prd/core-testnet/core_testnet_001
...
```
$ digitalbits-archivist mirror http://s3-eu-west-1.amazonaws.com/history.digitalbits.org/prd/core-testnet/core_testnet_001 file://local-archive

2016/02/10 18:27:09 mirroring http://s3-eu-west-1.amazonaws.com/history.digitalbits.org/prd/core-testnet/core_testnet_001 -> file://local-archive
...
```
$ digitalbits-archivist mirror --recent http://history.digitalbits.org/prd/core-live/core_live_001 file://local-archive

2019/08/21 13:53:15 mirroring http://history.digitalbits.org/prd/core-live/core_live_001 -> file://local-archive
...
```
$ digitalbits-archivist --last 1024 mirror http://history.digitalbits.org/prd/core-testnet/core_testnet_001 file://local-archive

2016/02/10 19:14:01 mirroring http://s3-eu-west-1.amazonaws.com/history.digitalbits.org/prd/core-testnet/core_testnet_001 -> file://local-archive
...
```
$ digitalbits-archivist scan file://local-archive
...
```
$ digitalbits-archivist --last 4096 scan file://local-archive
...
$ digitalbits-archivist --low 1000000 --high 1006000 scan file://local-archive
...
```
$ digitalbits-archivist --verify --last 4096 scan file://local-archive
...
$ digitalbits-archivist repair file://local-archive file://broken-archive
...
```
 digitalbits-archivist dumpxdr local-archive/transactions//00/20/de/transactions-0020de7f.xdr.gz
