...
func TestOptionalDigitalBitsFields(t *testing.T) {
	var val struct {
		F1 string `valid:"digitalbits_accountid,optional"`
		F2 string `valid:"optional,digitalbits_accountid"`
		F3 string `valid:"digitalbits_seed,optional"`
		F4 string `valid:"optional,digitalbits_accountid"`
	}
