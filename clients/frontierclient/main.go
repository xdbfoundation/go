...
var (
	...
	FrontierTimeout = 60 * time.Second
...
// This handler is used when getting the time from a frontier server, which can be used to calculate
...
type Client struct {
	...
	// AppName is the name of the application using the frontierclient package
	AppName string

	// AppVersion is the version of the application using the frontierclient package
	AppVersion     string
	frontierTimeout time.Duration
	isTestNet      bool
...
type FrontierRequest interface {
...
// See https://www.digitalbits.org/developers/frontier/reference/endpoints/path-finding-strict-receive.html
...
// See https://www.digitalbits.org/developers/frontier/reference/endpoints/path-finding-strict-send.html
