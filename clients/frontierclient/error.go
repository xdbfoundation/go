...
func (herr Error) Error() string {
	return `frontier error: "` + herr.Problem.Title + `" - check frontier.Error.Problem for more information`
}
...
// This can be stored, or decoded in the DigitalBits Laboratory XDR viewer for example.
