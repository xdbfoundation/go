...
// Upgrade upgrades the protocol version running on the digitalbits core instance
...
// SubmitTransaction calls the `tx` command on the connected digitalbits core with the provided envelope
