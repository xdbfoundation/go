...
// WellKnownPath represents the url path at which the digitalbits.toml file should
...
// Client represents a client that is capable of resolving a DigitalBits.toml file
// using the internet.
type Client struct {
...
// SEP-1 commit
// https://github.com/digitalbits/digitalbits-protocol/blob/f8993e36fa6b5b8bba1254c21c2174d250af4958/ecosystem/sep-0001.md
...
func GetDigitalBitsToml(domain string) (*Response, error) {
	return DefaultClient.GetDigitalBitsToml(domain)
}
...
func GetDigitalBitsTomlByAddress(addr string) (*Response, error) {
	return DefaultClient.GetDigitalBitsTomlByAddress(addr)
}
