// Package frontier contains the type definitions for all of frontier's
// response resources.
package frontier
...
// GetAccountID returns the DigitalBits account ID. This is to satisfy the
...
type Ledger struct {
	...
	BaseFee                    int32     `json:"base_fee_in_nibbs"`
	BaseReserve                int32     `json:"base_reserve_in_nibbs"`
...
type Root struct {
	...
	DigitalBitsCoreVersion           string    `json:"core_version"`
	IngestSequence               uint32    `json:"ingest_latest_ledger"`
	FrontierSequence              int32     `json:"history_latest_ledger"`
	FrontierLatestClosedAt        time.Time `json:"history_latest_ledger_closed_at"`
