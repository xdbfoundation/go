...
// InfoResponse is the json response returned from digitalbits-core's /info
// endpoint.
...
// IsSynced returns a boolean indicating whether digitalbitscore is synced with the
// network.
