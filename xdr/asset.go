...
// https://github.com/digitalbits/digitalbits-protocol/pull/313
...
func BuildAssets(s string) ([]Asset, error) {
	...
	for _, assetString := range assetStrings {
		...
		// Technically https://github.com/digitalbits/digitalbits-protocol/blob/master/ecosystem/sep-0011.md allows
		// any string up to 12 characters not containing an unescaped colon to represent XDB
		// however, this function only accepts the string "native" to represent XDB
