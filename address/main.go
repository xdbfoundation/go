// Package address provides utility functions for working with digitalbits
// addresses. See https://www.digitalbits.org/developers/guides/concepts/federation.
// html#digitalbits-addresses for more on addresses.
package address
